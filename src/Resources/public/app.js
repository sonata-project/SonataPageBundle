...
window.PageComposer = PageComposer; // auto-initialize plugin
...
jQuery.fn[pluginName] = function plugin(options) {
  return this.each(function plugins() {
    if (!jQuery.data(this, "plugin_".concat(pluginName))) {
      jQuery.data(this, "plugin_".concat(pluginName), new TreeView(this, options));
    }
  });
};
...
/* harmony import */ var _composer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./composer */ "./assets/js/composer.js");
/* harmony import */ var _composer__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_composer__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _treeview__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./treeview */ "./assets/js/treeview.js");
/* harmony import */ var _treeview__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_treeview__WEBPACK_IMPORTED_MODULE_4__);
/*!
 * This file is part of the Sonata Project package.
 *
 * (c) Thomas Rabaix <thomas.rabaix@sonata-project.org>
...
__webpack_require__.g.$ = (jquery__WEBPACK_IMPORTED_MODULE_1___default());
