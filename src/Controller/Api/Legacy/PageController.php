...
class PageController extends FOSRestController
{
     ...
     * @Rest\QueryParam(name="count", requirements="\d+", default="10", description="Number of pages per page")
     * @Rest\QueryParam(name="enabled", requirements="0|1", nullable=true, strict=true, description="Enables or disables the pages filter")
    ...
    protected function getPage($id)
    {
        ...
        if (null === $page) {
            throw new NotFoundHttpException(sprintf('Page not found for identifier %s.', var_export($id, true)));
        }
    ...
    protected function getBlock($id)
    {
        ...
        if (null === $block) {
            throw new NotFoundHttpException(sprintf('Block not found for identifier %s.', var_export($id, true)));
        }
