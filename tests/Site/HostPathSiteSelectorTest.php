...
final class HostPathSiteSelectorTest extends TestCase
{
    ...
    private function performHandleKernelRequestTest(string $url): array
    {
        ...
        $siteSelector = new HostPathSiteSelector(static::createStub(SiteManagerInterface::class), static::createStub(DecoratorStrategyInterface::class), static::createStub(SeoPageInterface::class));
