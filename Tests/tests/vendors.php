...
$deps = array(
    ...
    array('Sonata/CacheBundle', 'git://github.com/sonata-project/SonataCacheBundle.git', 'origin/2.0'),
    array('Sonata/BlockBundle', 'git://github.com/sonata-project/SonataBlockBundle.git', 'origin/2.0'),
